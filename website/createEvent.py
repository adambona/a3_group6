...
def createEvent():
    ...
    if form.validate_on_submit():
        ...
        event = Event(event_id = form.event_id.data, user_id=form.user_id.data, status = form.status.data, genre=form.genre.data, name=form.name.data, artist_name=form.artist_name.data, start_time=form.start_time.data, end_time=form.end_time.data, location=form.location.data, ticket_price=form.ticket_price.data, num_tickets=form.num_tickets.data, description=form.description.data, image=form.image.data)
